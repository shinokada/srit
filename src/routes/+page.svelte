...
&lt;/picture&gt;
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>avif</td>
        <td
          >An optional prop that specifies whether to include an avif source in the picture element.</td
        >
        <td>true</td>
      </tr>
      <tr>
        <td>webp</td>
        <td
          >An optional prop that specifies whether to include a webp source in the picture element.</td
        >
        <td>true</td>
      </tr>
      <tr>
        <td>sizes</td>
        <td
          >An optional prop that specifies an array of image sizes to include in the srcset
          attribute of the img element.</td
        >
      ...
      <tr>
        <td>loading</td>
        <td
          >A string indicating whether the image should be lazily loaded. Can be "lazy", "eager",
          null, or undefined.</td
        >
        <td>lazy</td>
      </tr>
      <tr>
        <td>decoding</td>
        <td
          >A string indicating the decoding mode for the image. Can be "async", "auto", "sync",
          null, or undefined.</td
        >
        <td>async</td>
      </tr>
  ...
  <h2>Component document</h2>

  <p>
    If you are using an LSP-compatible editor, such as VSCode, Atom, Sublime Text, or Neovim,
    hovering over a component name will display a documentation link, features, props, events, and
    an example.
  </p>
  ...
  <img
    width="345"
    height="192"
    src="https://github.com/shinokada/srit/blob/main/static/images/compo-doc.png?raw=true"
    alt="component doc example"
  />

  <h2>Bimgc to create all your images from one image</h2>

  <p>
    You can convert your image to all AVIF and WEBP images by using <a
      href="https://bimgc.codewithshin.com/?id=package-usage">bimgc</a
    >.
  </p>
...
&#125;</code
  ...
  <p>
    Find more information about <a href="https://bimgc.codewithshin.com/?id=package-usage">bimgc</a
    >.
  </p>
</main>
